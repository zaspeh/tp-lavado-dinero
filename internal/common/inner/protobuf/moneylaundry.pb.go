...
const (
	...
	MessageType_MICROTRANSACTION_RESULT MessageType = 7
	MessageType_MAXBANK_RESULT          MessageType = 8
)
...
const file_tp_lavado_dinero_internal_common_inner_protobuf_moneylaundry_proto_rawDesc = "" +
	...
	"\x16GROUPED_ACCOUNTS_BATCH\x10\x06\x12\x1b\n" +
	"\x17MICROTRANSACTION_RESULT\x10\a\x12\x12\n" +
	"\x0eMAXBANK_RESULT\x10\bB1Z/tp-lavado-dinero/internal/common/inner/protobufb\x06proto3"
