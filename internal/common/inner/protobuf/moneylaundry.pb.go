...
const (
	...
	MessageType_MICROTRANSACTION_RESULT MessageType = 8
	MessageType_MAXBANK_RESULT          MessageType = 9
)
...
const file_internal_common_inner_protobuf_moneylaundry_proto_rawDesc = "" +
	...
	"\x14AVGBYTYPETRANSACTION\x10\a\x12\x1b\n" +
	"\x17MICROTRANSACTION_RESULT\x10\b\x12\x12\n" +
	"\x0eMAXBANK_RESULT\x10\tB1Z/tp-lavado-dinero/internal/common/inner/protobufb\x06proto3"
